...
func GetClientArch(streamStdio bool) (string, string) {
	task := execute.ExecTask{Command: "uname", Args: []string{"-m"}, StreamStdio: streamStdio}
	...
	taskOS := execute.ExecTask{Command: "uname", Args: []string{"-s"}, StreamStdio: streamStdio}
